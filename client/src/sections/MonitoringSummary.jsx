...
export default function MonitoringSummary() {
  ...
  return (
    ...
    >
      ...
      >
        {/* =================================================
            BMKG WEATHER SECTION (PALING ATAS)
        ================================================= */}
        ...
        >
          ...
          <p
            ...
            "
          >
            Data berikut berasal dari sensor IoT yang dipasang pada area penelitian
            di Pusuk Sembalun dan diperbarui secara langsung melalui sistem
            monitoring JagaBumi.
          </p>
        </div>
        ...
        >
          ...
          <div className="h-full min-w-0">
            <MonitoringCard
              ...
              status={
                sensor
                  ? `Indeks Risiko ${sensor.fuzzy_value}%`
                  : "Menunggu data..."
              }
            />
          </div>
